@props(['actions', 'alignment' => 'left', 'fullWidth' => false])
...
@elseif (is_array($actions))
    ...
    @php
        $actions = array_filter($actions, fn(\Filament\Pages\Actions\Action|\Filament\Pages\Actions\ActionGroup|\AlperenErsoy\FilamentExport\Actions\FilamentExportBulkAction $action): bool => !$action->isHidden());
    @endphp
