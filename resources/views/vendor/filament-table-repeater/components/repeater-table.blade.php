                ...
                <thead @class([
                    ...
                    <tr class="md:divide-x md:rtl:divide-x-reverse md:divide-gray-300 dark:md:divide-gray-700 text-sm">
                        @foreach ($headers as $key => $header)
                            <th @class([
                                'filament-table-repeater-header-column px-3 py-2 font-medium text-center text-gray-600 dark:text-gray-300 bg-gray-200/50 dark:bg-gray-900/60',
                        ...
                        @if ($hasActions)
                            <th
                                class="filament-table-repeater-header-column p-2 bg-gray-200/50 dark:bg-gray-900/60 w-px ltr:rounded-tr-xl rtl:rounded-tl-xl">
                    ...
                    @if ($hasActions)
                        <td class="filament-table-repeater-column p-2 w-px">
                            <div class="flex items-center md:justify-center">
                                ...
                                @if ($isCloneable)
                                    <button title="{{ __('forms::components.repeater.buttons.clone_item.label') }}"
